<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="data_monitoring.aspx.cs" Inherits="percobaan.data_monitoring" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="formdatamonitoring" runat="server">
        <asp:MultiView ID="MultiVieworder" runat="server">
            <asp:View ID="View1" runat="server">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="gvv table table-striped table-hover table-bordered" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" OnRowDeleting="GridView1_RowDeleting" OnRowUpdating="GridView1_RowUpdating" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Tanggal  Order" DataField="tgl_order" />
                        <asp:BoundField HeaderText="Klien" DataField="nama_klien" />
                        <%--<asp:BoundField HeaderText="Kode Officer" DataField="kode_officer" />--%><%--<asp:BoundField HeaderText="Kode Layanan" DataField="kode_layanan" />--%>
                        ...
                        <asp:TemplateField ControlStyle-ForeColor="Blue" HeaderText="Aksi">
                            <ItemTemplate>
                                ...
                                <%--<asp:LinkButton ID="btnlihat" runat="server" CausesValidation="false" CommandArgument='<%#Eval("kode_order").ToString()%>'><img src="stylelogin/images/delete.png" title="hapus" width="20" /></asp:LinkButton>--%>
            ...
            <asp:View ID="View2" runat="server">
                ...
                <div id="acordian" style="width: 400px">
                    <h3>header 1</h3>
    ...
    <script>
        function ConfirmDelete() {
            ...
            document.forms["formdatamonitoring"].appendChild(c_val);
        }
        $(function () {
