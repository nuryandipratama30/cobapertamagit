<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="datasuratkeluar.aspx.cs" Inherits="percobaan.datasuratkeluar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form id="formdatasuratkeluar" runat="server">
        <asp:MultiView ID="MultiViewsuratkeluar" runat="server">
            <asp:View ID="View1" runat="server">
                <label style="padding-left: 400px; font-size: 40pt">Data Surat Keluar</label>
                <br />
                <div>
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="gvv table table-striped table-hover table-bordered" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" OnRowDeleting="GridView1_RowDeleting" OnRowUpdating="GridView1_RowUpdating" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="tujuan_surat" HeaderText="Tujuan Surat" />
            ...
            <asp:View ID="View2" runat="server">
                <div class="modal-header" style="text-align: center">
                    <label><b>Form Surat Keluar</b></label>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                       ...
                       <%-- <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="tidak boleh ada angka dan tanda lain selain '," ForeColor="Red" ControlToValidate="txtno_surat"
                            ValidationExpression="^\b[0-9\s\]{1,100}$"></asp:RegularExpressionValidator>--%>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="txttujuansurat">
                            Tujuan Surat
                        </label>
                        <asp:TextBox ID="txttujuansurat" runat="server" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required" Font-Bold="True" ForeColor="Red" ControlToValidate="txttujuansurat"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Error Format" ForeColor="Red" ControlToValidate="txttujuansurat"
    ...
    <script>
        function ConfirmDelete() {
            ...
            document.forms["formdatasuratkeluar"].appendChild(c_val);
        }
        $(function () {
