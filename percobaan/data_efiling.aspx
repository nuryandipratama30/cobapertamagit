<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="data_efiling.aspx.cs" Inherits="percobaan.data_efiling" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form id="formdataefiling" runat="server">
        <asp:MultiView ID="MultiViewefiling" runat="server">
            <asp:View ID="View1" runat="server">
                <label style="padding-left: 500px; font-size: 40pt">Data e-Filling</label>
                <br />
                <div>
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="gvv table table-striped table-hover table-bordered" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" OnRowDeleting="GridView1_RowDeleting" OnRowUpdating="GridView1_RowUpdating" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="nama_file" HeaderText="Nama File" />
                        ...
                        <asp:TemplateField ControlStyle-ForeColor="Blue" HeaderText="Aksi">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnupdate" runat="server" CausesValidation="false" CommandArgument='<%#Eval("kode_efiling").ToString()%>' CommandName="ubah"><img src="stylelogin/images/edit.png" title="ubah" width="20" /></asp:LinkButton>
                                <asp:LinkButton ID="btndelete" runat="server" CausesValidation="false" CommandArgument='<%#Eval("kode_efiling").ToString()%>' CommandName="hapus" OnClientClick="ConfirmDelete()"><img src="stylelogin/images/delete.png" title="hapus" width="20" /></asp:LinkButton>
                            </ItemTemplate>
            ...
            <asp:View ID="View2" runat="server">
                ...
                <div class="modal-header" style="text-align: center">
                    <label style="font-size: 36pt; padding-left: 40px"><b>Form E-Filing</b></label>
                </div>
                <%--<div></div>--%>
                <div class="modal-body">
                    <div class="form-group" style="padding-left:10px">
                        <label for="txtkodeefiling">
                            Kode e-Filing
                        </label>
                        <asp:TextBox ID="txtkodeefiling" runat="server" placeholder="Kode e-Filing" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic" ErrorMessage="Required" Font-Bold="True" ForeColor="Red" ControlToValidate="txtkodeefiling"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="hanya bisa menginputkan huruf K,E,F dan 3 digit angka dibelakangnya(ex KEF001)" ForeColor="Red" ControlToValidate="txtkodeefiling"
                            ValidationExpression="^\b[0-9KEF]{6}$"></asp:RegularExpressionValidator>
                    </div>
                    <div class="form-group" style="padding-left:10px">
                        <label for="ddljenis">
                            Jenis
                        </label>
                        <asp:DropDownList ID="ddljenis" CssClass="form-control" AutoPostBack="true" runat="server" AppendDataBoundItems="true" OnSelectedIndexChanged="ddljenis_SelectedIndexChanged">
                            <asp:ListItem Text="---pilih---"></asp:ListItem>
                            <asp:ListItem Text="Order" Value="Order"></asp:ListItem>
                            <asp:ListItem Text="Klien" Value="Klien"></asp:ListItem>
                            <asp:ListItem Text="Akta" Value="Akta"></asp:ListItem>
                            <asp:ListItem Text="Keuangan" Value="Keuangan"></asp:ListItem>
                            <asp:ListItem Text="SSP" Value="SSP"></asp:ListItem>
                            <asp:ListItem Text="SSB" Value="SSB"></asp:ListItem>
                            <asp:ListItem Text="Konfirmasi Bayar" Value="Konfirmasi Bayar"></asp:ListItem>
                    ...
                    <div class="form-group" style="padding-left:10px">
                        ...
                        <asp:DropDownList ID="ddlinfo" CssClass="form-control" runat="server" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlinfo_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </div>
                ...
                <div class="form-group" style="padding-left:30px">
                    ...
                    <asp:TextBox ID="txttgl" placeholder="Info" class="form-control" TextMode="Date" runat="server"></asp:TextBox>
                ...
                <div class="form-group" style="padding-left:30px">
                    ...
                    <asp:TextBox ID="txtcatatan" placeholder="Info" class="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
                </div>
                <%--<div class="modal-body">
