...
namespace percobaan
{
    public partial class data_monitoring : System.Web.UI.Page
    {
        controllerklien ctlk;
        controllermonitoringbpn ctlo;
        ...
        {
            ctlo = new controllermonitoringbpn();
            GridView1.DataSource = ctlo.getdataorder();
            GridView1.DataBind();
            //ctll = new controllerlayanan();
            //GridView2.DataSource = ctll.getdatalayanan();
            //GridView2.DataBind();
        }
